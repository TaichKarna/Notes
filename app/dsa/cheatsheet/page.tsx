  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 18, fontWeight: 700, letterSpacing: "-0.5px", color: "#2563eb" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px" }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
              <span style={{ fontSize: 28, color: "#2563eb" }}>{ds.icon}</span>
              <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: "#1a1a1a" }}>{active}</h2>
            </div>
            <p style={{ margin: "0 0 16px", color: "#6b7280", fontSize: 13 }}>{ds.desc}</p>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 10, color: "#2563eb", fontWeight: 700, marginBottom: 6, letterSpacing: "1px" }}>
                INITIALIZATION
              </div>
              <pre style={{ margin: 0, fontSize: 12, color: "#1e40af", whiteSpace: "pre-wrap", lineHeight: 1.7 }}>
                {ds.init}
              </pre>
            </div>
          </div>
